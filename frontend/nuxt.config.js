export default {
  ...
  css: ["~/assets/scss/main.scss", "mdbvue/lib/css/mdb.min.css"],
    ...
    vueI18n: {
      ...
      messages: {
        en: {
          ...
          intro:
            "I'm Mark Varga, a web developer. I design and build websites.",
          ...
          content1:
            "I think it is very important to be up to date and to improve our knowledge. With my experience, I can help you, whether it’s frontend or backend development.",
          content2:
            "The essence of this method is to be able to involve customers in the development and in this way they will be completely satisfied with the end result.",
          content3:
            "Whether it’s a one-page website or even a web application with a more complex structure, it’s all feasible, it depends on your imagination. :)",
          content4:
            "I help make your website (s) fully responsive and provide the right user experience on all display devices.",
          content5:
            "I can help you improve your existing website (s) and process its content according to your own needs.",
          entreContent:
            "Anyone who is serious about success in the job market, they mustn't think for a second about whether or not they need an online portfolio!",
          indiContent:
            "Nowadays, it is considered a virtually missed issue if an entrepreneur isn't present at the diversified world of the Internet, which provides plenty of opportunities to show and advertise products and services to customers.",
          aboutIntro:
            "My qualifications are business informatics and web development. I graduated as a business informatics technician in 2019. I have two diplomas in web development. I dropped into the world of web development in 2018 and since then we have been inseparable from each other, I am developing my knowledge constantly, I can now work as a web developer to maximize the satisfaction of my clients and employers.",
          entrepreneurIntro:
          ...
          inflationContent:
            "This project was about creating an inflation calculator web application, the users can apply custom weighting and set all of the main and subcategories that come from the KSH system, so they can calculate a specialized value for themselves.",
          tech: "Technology",
          description: "Description",
          here: "Show me!",
          interest:
            "If I convince You, I am waiting for your application at these contacts:",
          social: "But you also find me on different social interfaces:",
          future:
            "If you would like to discuss your future website with me in person:",
          leaderboard:
            "A summary table of results that obtains data from multiple sources and in this way can dynamically provide users with up-to-date data.",
        ...
        hu: {
          ...
          intro:
            "Varga Márk vagyok, webfejlesztő. Weboldalak tervezésével és kivitelezésével foglalkozom.",
          ...
          inflationContent:
            "Ez a projektmunka egy inflációs kalkulátor webalkalmazás létrehozásáról szólt, aminek a célja, hogy egyéni súlyozást tudjon beállítani a felhasználó minden fő- és alkategóriára, amik a KSH rendszeréből származnak, így a felhasználó specializált értéket tud magának kiszámolni.",
          tech: "Technológia",
          description: "Leírás",
          here: "Nézzük!",
          interest:
            "Ha sikerült meggyőznöm, akkor ezekre az elérhetőségekre várom a jelentkezésed:",
          social: "De elérsz a különböző közösségi felületeken is:",
          future:
            "Ha esetleg személyesen szeretnél velem tárgyalni leendő weboldaladról:",
          leaderboard:
            "Egy eredményeket összefoglaló táblázat, amely több forrásból szerzi be az adatokat és így dinamikusan, friss adatokkal tudja ellátni a felhasználókat.",
