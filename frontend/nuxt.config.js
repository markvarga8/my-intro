    ...
    vueI18n: {
      ...
      messages: {
        en: {
          ...
          content1: 'I think it is very important to be up to date and to keep our knowledge updated. With my experience gained over the years, I can help you, whether it’s frontend or backend development.',
          content2: 'The essence of this method is to be able to involve customers more in the development and thus be completely satisfied with the end result.',
          content3: 'Whether it’s a one-page website or even a web application with a more complex structure, it’s all feasible, it’s up to your imagination. :)',
        ...
        hu: {
          ...
          content1: 'Nagyon fontosnak tartom, hogy naprakészek legyünk és a tudásunkat is folyamatosan fríssitsük. Az évek alatt összeszedett tapasztalatommal tudlak segíteni, legyen szó frontend vagy backend oldali fejlesztésről.',
